# ReviewRequest Submission

This automation features a basic review request submission workflow that posts the review request
raised to channel.
...
$ slack create my-app -t slack-samples/deno-review request-submission
...
```zsh
$ slack trigger create --trigger-def triggers/submitreview.ts
```
